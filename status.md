...
1. 驗證 `恐龍雕像` (25.0019,121.3276426) 周邊是否有「恐龍園區」指標與河濱自行車道
2. 判讀 2.5km 指標園區名（鯨魚圖示暗示海洋／親水主題）
3. 用「恐龍園區 0.3km + 該公園 2.5km」的幾何關係反推河段
4. **確認雕像 2019 年存在、現已移除**（題敘明示雕像已不在）
5. 用 Google Earth 歷史影像比對草地上的雕像基座
...
**Jurassic 提交紀錄：0 / 10 —— 從未提交過任何答案，10 次機會完整保留。**
